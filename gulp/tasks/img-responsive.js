		...
		return $.gulp.src(src)
			...
			.pipe($.gp.responsive({
				'*': [{
				 ...
				 {
					// Produce @1x images
					width: '100%', quality: 1, progressive: true,  rename: { prefix: '@0x/50%/', }
				},
				...
				// },
					...
					{ 	width: '100%',quality: 1, progressive: true,  rename: { prefix: '@0x/', extname: '.webp', 	},
					},
					
					{ 	width: '100%',quality: 1, progressive: true,  rename: { prefix: '@0x/50%/', extname: '.webp', 	},
					},
